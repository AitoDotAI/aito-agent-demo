...
Run normally (replay, no live calls):

    ./do test-book

When the Aito schema legitimately changes (you load a new table, add a
column), re-record the snapshot against live Aito and accept the new output:

    ./do test-book -s -a book/test_01_aito_schema_book.py
"""
